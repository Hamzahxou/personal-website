...
export default function AboutPage() {
  return (
    <section className="w-full h-screen overflow-hidden bg-foreground relative px-10">
      <div className="absolute top-0 left-0 bottom-0 right-0 flex flex-col gap-6 md:gap-10 items-center justify-center select-none text-7xl md:text-8xl z-0">
      ...
      <div className="z-20 flex h-full w-full justify-center items-center relative">
        <div>
          <h1 className="text-secondary text-5xl uppercase font-bold mb-4">
            I{"'"}m{" "}
          ...
          <p className="md:w-96 text-secondary text-center text-md italic">
